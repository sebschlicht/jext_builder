...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--ssh_host', help='specify the SSH host, if releasing an update')
    parser.add_argument('-P', '--ssh_port', help='specify the SSH port, if releasing an update')
    parser.add_argument('-u', '--ssh_user', help='specify the SSH user, if releasing an update')
    parser.add_argument('-p', '--ssh_password', help='specify the SSH password, if releasing an update')
    parser.add_argument('-d', '--remote_dir', help='remote root directory for Joomla extensions')
